\\023\000\026\000\007\000\007\000\
\\040\000\080\000\007\000\007\000\
\\017\000\075\000\018\000\024\000\
\\007\000\027\000\015\000\019\000\
\\037\000\068\000\007\000\052\000\
\\055\000\044\000\090\000\089\000\
\\094\000\007\000\020\000\097\000\
\\098\000\007\000\081\000\007\000\
\\091\000\041\000\070\000\056\000\
\\007\000\092\000\000\000"
val gotoT =
"\
\\001\000\002\000\002\000\138\000\003\000\001\000\000\000\
\\000\000\
\\000\000\
\\000\000\
\\000\000\
...
|  ( 7, ( ( _, ( MlyValue.expr expr2, expr2left, expr2right)) :: _ ::
 _ :: ( _, ( MlyValue.expr expr1, _, _)) :: ( _, ( _, LBRACKleft, _))
...
|  ( 8, ( ( _, ( MlyValue.expr expr2, expr2left, expr2right)) :: _ :: 
( _, ( MlyValue.ID ID2, ID2left, _)) :: _ :: _ :: ( _, ( MlyValue.expr
 expr1, _, _)) :: ( _, ( _, LBRACKleft, _)) :: ( _, ( MlyValue.ID ID1,
...
|  ( 10, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.exprList 
...
|  ( 24, ( ( _, ( _, _, RPAREN1right)) :: ( _, ( MlyValue.exprSeq 
...
|  ( 28, ( ( _, ( MlyValue.expr expr3, _, expr3right)) :: _ :: ( _, ( 
MlyValue.expr expr2, _, _)) :: _ :: ( _, ( MlyValue.expr expr1, _, _))
...
|  ( 30, ( ( _, ( _, _, END1right)) :: ( _, ( MlyValue.exprSeq 
...
|  ( 31, ( rest671)) => let val  result = MlyValue.exprList (fn _ => (
[]))
...
|  ( 34, ( rest671)) => let val  result = MlyValue.exprSeq (fn _ => (
[]))
 in ( LrTable.NT 5, ( result, defaultPos, defaultPos), rest671)
end
|  ( 35, ( ( _, ( MlyValue.expr expr1, (exprleft as expr1left), 
...
|  ( 36, ( ( _, ( MlyValue.expr expr1, exprleft, expr1right)) :: _ :: 
...
|  ( 40, ( ( _, ( MlyValue.declaration declaration1, declaration1left,
...
|  ( 44, ( ( _, ( MlyValue.typeDec typeDec1, typeDec1left, 
...
|  ( 45, ( ( _, ( MlyValue.typeVal typeVal1, _, typeVal1right)) :: _
...
|  ( 48, ( ( _, ( MlyValue.ID ID1, _, ID1right)) :: _ :: ( _, ( _, (
...
|  ( 53, ( rest671)) => let val  result = MlyValue.typeFieldList (fn _
 => ([]))
 in ( LrTable.NT 11, ( result, defaultPos, defaultPos), rest671)
end
|  ( 54, ( ( _, ( MlyValue.typeField typeField1, typeField1left, 
...
|  ( 55, ( ( _, ( MlyValue.typeField typeField1, _, typeField1right))
...
|  ( 58, ( ( _, ( MlyValue.ID ID1, IDleft, ID1right)) :: _ :: ( _, ( 
...
|  ( 59, ( ( _, ( _, _, RBRACK1right)) :: ( _, ( MlyValue.expr expr1,
